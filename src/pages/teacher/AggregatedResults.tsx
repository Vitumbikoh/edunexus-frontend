...
interface ResultRow { id:string; studentId:string; courseId:string; termId:string; finalPercentage?:string|null; finalGradeCode?:string|null; pass?:boolean|null; status:string; }
            ...
            <Table>
              ...
              <TableBody>
                {loading ? (
                  ...
                  <TableRow><TableCell colSpan={5} className="text-center py-6 text-muted-foreground">No results</TableCell></TableRow>
                ) : (
                  filtered.map(r=> (
                    <TableRow key={r.id}>
