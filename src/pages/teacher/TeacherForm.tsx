...
export default function TeacherForm() {
  ...
  // username only used/displayed in edit mode (auto-generated by backend)
  username: '',
    firstName: '',
    lastName: '',
    phoneNumber: '',
      ...
      const fetchTeacher = async () => {
        try {
          ...
          setFormData({
            ...
            // Username now managed only in edit mode (hidden on create)
            // If backend auto-generates usernames, we keep it for display only
  ...
  const requestBody: any = {
      ...
      // Only include username on edit if we actually have it
    ...
    <div className="space-y-6">
      ...
      {isEditMode && (
                <div className="space-y-2">
                  ...
                  <Input 
                    id="username" 
        // read-only display of existing backend-provided username
